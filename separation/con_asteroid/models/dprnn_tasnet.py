'''
Modified from asteroid.models.dprnn_tasnet.py
'''
from ..multichannel_wrapper import multichannel_make_enc_dec
...
class DPRNNTasNet_multichannel(BaseEncoderMaskerDecoder):
    ...
    def __init__(
        ...
        **fb_kwargs,
        ...
        encoder, decoder = multichannel_make_enc_dec(
            num_channels=2,
            fb_name=fb_name,
