...
class TCNN_Encoder(nn.Module):
    def __init__(self, input_channel=1, output_channel=1):
        ...
        self.Conv2d_1 = nn.Sequential(
            nn.Conv2d(in_channels=input_channel, out_channels=16, kernel_size=(3, 5), stride=(1, 1), padding=(1, 2)),
        ...
        self.fc = nn.Linear(64, output_channel)
    ...
    def forward(self, input):
        ...
        reshape_2 = torch.nn.functional.adaptive_avg_pool2d(reshape_2, (1, 1))[:, :, 0, 0]
...
class TCNN(nn.Module):
    def __init__(self, input_channel=1, output_channel=1):
        ...
        self.DConv2d_1 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32, out_channels=output_channel, kernel_size=(3, 5), stride=(1, 1), padding=(1, 2),
                               output_padding=(0, 0)),
